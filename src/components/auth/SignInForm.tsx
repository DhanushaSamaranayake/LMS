  ...
  const handleSubmit = useCallback((e: FormEvent) => {
    ...
    setTimeout(() => {
      if (email === "admin@gmail.com" && password === "password123") {
        console.log("Sign in successful:", { email, password, rememberMe: isChecked });
        setLoading(false);
        navigate("/");
      } else {
        setLoading(false);
        setModalMessage("Email or password incorrect. Please check your credentials and try again.");
        openModal();
      }
    }, 1500);
